			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="content-area">
						<div class="area-head">
							<h1 class="mt-4 mb-2rem">Perform Employee Action</h1>
							<div class="breadCrumb border-top border-bottom mb-4">
								<ul class="mt-2 mb-2 p-0">
									...
									<li class="d-inline-block">Perform Employee Action</li>
								</ul>
							</div>
									...
									<div class="row">
										...
										<div class="col-lg-10 pt-4 pb-4 col-md-10">
											<div class="unit-action">
												<a href="#" class="button outline_button mx-w-120px d-inline-block mr-3">Re-assign</a>
												<a href="#" class="button outline_button mx-w-120px d-inline-block">Promote</a>
												<a href="#" class="button outline_button mx-w-120px d-inline-block float-right">Terminate</a>
											</div>
										</div>
									</div>
								</div>
