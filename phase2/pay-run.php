				...
				<div class="col-lg-4 col-md-4">
					...
					<div class="checklist border rounded p-3 ">
						<ul class="p-0 m-0">
							...
							<li class="checked">Employee Grades</li>
							<li class="checked">Leave Reconcilliations</li>
							<li class="checked">Time & Attendance</li>
							<li class="checked">Compiling reports - Aborted</li>
						</ul>					
					</div>
				</div>
				<div class="col-lg-8 col-md-8">
					...
					<div class="border rounded p-3">
						<ul class="results-col p-0">
							<li>Pay run initiated</li>
							<li>Processing...</li>
							<li>Pay run complete.</li>
							<li>Pay period closed. View reports below</li>							
						</ul>						
					</div>
				</div>				
			</div>
